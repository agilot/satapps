...
class SetsTest extends AnyFunSuite{
  test("incl"){
    val set: MultiSet[Int] = ImMultiSet(Map())
  ...
  test("excl"){
    val set: MultiSet[Int] = ImMultiSet(Map(1 -> 1, 2 -> 2, 3 -> 3))
    val set2 = set - 1 - 2 - 3
    assert(!set2.contains(1))
    assert(set2.contains(2))
    assert(set2.contains(3))
  ...
  test("inter"){
    val set: MultiSet[Int] = ImMultiSet(Map(1 -> 1, 2 -> 2, 3 -> 3, 4 -> 4))
    val set2: MultiSet[Int] = ImMultiSet(Map(0 -> 1, 1 -> 1, 2 -> 1, 3 -> 4))
    val set3 = set & set2
    assert(set3(0) == 0 && set3(1) == 1 && set3(2) == 1 && set3(3) == 3 && set3(4) == 0)
    assert(set3 == ImMultiSet(Map(1 -> 1, 2 -> 1, 3 -> 3)))
  }
  ...
  test("union"){
    ...
    assert(set3 == ImMultiSet(Map(0 -> 1, 1 -> 1, 2 -> 2, 3 -> 4, 4 -> 4)))
  }
